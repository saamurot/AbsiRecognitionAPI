...
namespace StaticWebAPI.Business.Entities
{
    public class MasterEntity
    {
        ...
        public string CompanyOrRelation { get; set; }
        ...
        public string SurgeryInThePast { get; set; }
        ...
        public string MannerOfEntry { get; set; }
