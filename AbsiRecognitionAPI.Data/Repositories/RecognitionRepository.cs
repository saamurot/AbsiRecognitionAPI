...
namespace AbsiRecognitionAPI.Data.Repositories
{
    public class RecognitionRepository : Repository, IRecognitionRepository
    {
        ...
        public IEnumerable<T> GetKudosByUserIDandDate<T>(object filter)
        {
            try
            {
                return db.Query<T>("SProc_GetKudosByUserIDandDate", filter, commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public IEnumerable<T> GetManagerPointsTransactionsByUserID<T>(object filter)
        {
            try
            {
                return db.Query<T>("SProc_GetManagerPointsTransactionsByUserID", filter, commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
            {
                throw ex;
